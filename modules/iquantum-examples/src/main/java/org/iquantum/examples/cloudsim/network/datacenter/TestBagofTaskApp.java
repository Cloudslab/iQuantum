...
import org.iquantum.network.datacenter.AppCloudlet;
import org.iquantum.network.datacenter.NetworkCTask;
import org.iquantum.network.datacenter.NetworkConstants;
import org.iquantum.network.datacenter.TaskStage;
    ...
    public void createCloudletList(List<Integer> vmIdList){
		...
		int t=NetworkConstants.currentCloudletId;
	  	for(int i=0;i<numbervm;i++){
    		...
    		NetworkCTask cl = new NetworkCTask(NetworkConstants.currentCloudletId, executionTime/numbervm, pesNumber, fileSize, outputSize, memory, utilizationModel, utilizationModel, utilizationModel);
