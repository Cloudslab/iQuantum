package org.iquantum.examples.container;

import org.iquantum.backends.classical.container.containerPlacementPolicies.*;
import org.iquantum.backends.classical.container.core.*;
import org.iquantum.backends.classical.container.hostSelectionPolicies.*;
import org.iquantum.backends.classical.container.containerSelectionPolicies.PowerContainerSelectionPolicy;
import org.iquantum.backends.classical.container.containerSelectionPolicies.PowerContainerSelectionPolicyCor;
import org.iquantum.backends.classical.container.containerSelectionPolicies.PowerContainerSelectionPolicyMaximumUsage;
...
import org.iquantum.backends.classical.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationStaticThresholdMC;
import org.iquantum.backends.classical.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationStaticThresholdMCUnderUtilized;
import org.iquantum.backends.classical.container.resourceAllocators.ContainerAllocationPolicy;
import org.iquantum.backends.classical.container.resourceAllocators.ContainerAllocationPolicyRS;
...
import org.iquantum.backends.classical.container.vmSelectionPolicies.PowerContainerVmSelectionPolicyMaximumCorrelation;
...
/**
 * The RunnerAbs Class is the modified version of {@link org.iquantum.examples.power.RunnerAbstract}
...
public abstract class RunnerAbs {
     ...
     * The Cloudlet List
     */
    protected static List<ContainerCTask> cloudletList;
    /**
...
//            PowerContainerDatacenter e = (PowerContainerDatacenter) HelperEx.createDatacenter("Datacenter", PowerContainerDatacenter.class, hostList, vmAllocationPolicy, containerAllocationPolicy);
            ...
            ;
            iQuantum.terminateSimulation(86400.0D);
