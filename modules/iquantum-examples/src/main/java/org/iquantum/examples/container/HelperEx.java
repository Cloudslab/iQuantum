...
import org.iquantum.backends.classical.HostStateHistoryEntry;
...
import org.iquantum.backends.classical.container.resourceAllocatorMigrationEnabled.PowerContainerVmAllocationPolicyMigrationAbstract;
...
import org.iquantum.policies.vm.VmStateHistoryEntry;
...
/**
 * This is the modified version of {@link org.iquantum.examples.power.Helper} class in cloudsim.
...
//        System.out.print();
    ...
    public static List<ContainerCTask> createContainerCloudletList(int brokerId, String inputFolderName, int numberOfCloudlets)
        ...
        for (File aFiles1 : files1) {
            ...
            for (int i = 0; i < files.length; ++i) {
                if (createdCloudlets < numberOfCloudlets) {
                    ...
                    try {
                        cloudlet = new ContainerCTask(IDs.pollId(ContainerCTask.class), 216000000L * 1000, 1, fileSize, outputSize,
...
//        }
        ...
        CSVWriter writer = new CSVWriter(bufferedWriter, CSVWriter.DEFAULT_SEPARATOR, CSVWriter.NO_QUOTE_CHARACTER, CSVWriter.DEFAULT_ESCAPE_CHARACTER, CSVWriter.DEFAULT_LINE_END);
