...
public class QDatacenterExtended extends SimEntity {

    /** The characteristics. */
    private QDatacenterCharacteristicsExtended characteristics;
    ...
    public QDatacenterExtended(String name, QDatacenterCharacteristicsExtended characteristics) {
        super(name);
    ...
    protected void setCharacteristics(QDatacenterCharacteristicsExtended characteristics) {
        this.characteristics = characteristics;
    }

    public QDatacenterCharacteristicsExtended getCharacteristics() {
