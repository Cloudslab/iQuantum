 ...
 */
public class CDatacenterCharacteristics {
	 ...
	 * @post $none
	 */
	public CDatacenterCharacteristics(
			String architecture,
			String os,
			String vmm,
	...
	public int getMips() {
		...
		switch (getAllocationPolicy()) {
                        ...
                        /*@todo But it is possible to add PMs of different configurations
                            ...
                            of a Datacenter*/
			case CDatacenterCharacteristics.TIME_SHARED:
			case CDatacenterCharacteristics.OTHER_POLICY_SAME_RATING:
			...
			case CDatacenterCharacteristics.SPACE_SHARED:
			case CDatacenterCharacteristics.OTHER_POLICY_DIFFERENT_RATING:
