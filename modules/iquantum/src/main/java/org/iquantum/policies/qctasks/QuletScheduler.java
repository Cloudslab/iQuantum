 ...
 * quantum node to run its {@link QTask Qulets}.
...
public abstract class QuletScheduler {
	...
	protected List<? extends ResQTask> quletWaitingList;

	/** The list of Qulets being executed on the QNode. */
	protected List<? extends ResQTask> quletExecList;

	/** The list of paused Qulets. */
	protected List<? extends ResQTask> quletPausedList;

	/** The list of finished Qulets. */
	protected List<? extends ResQTask> quletFinishedList;

	/** The list of failed Qulets. */
	protected List<? extends ResQTask> quletFailedList;
	...
	public QuletScheduler() {
		setPreviousTime(0.0);
		quletWaitingList = new LinkedList<ResQTask>();
		quletExecList = new LinkedList<ResQTask>();
		quletPausedList = new LinkedList<ResQTask>();
		quletFinishedList = new LinkedList<ResQTask>();
		quletFailedList = new LinkedList<ResQTask>();
	}
	 ...
	 * @post $none
	 */
	public abstract double quletSubmit(QTask ql, double fileTransferTime);
	 ...
	 * @post $none
	 */
	public abstract double quletSubmit(QTask ql);
	 ...
	 * @post $none
	 */
	public abstract QTask quletCancel(int qlId);
	 ...
	 * @post $none
	 */
	public abstract void quletFinish(ResQTask rql);
	 ...
	 * @post $none
	 */
	public abstract QTask getNextFinishedQulet();
	...
	public abstract Map<String, String> quletMapping(QTask QTask, QNode qNode);
	 ...
	 * @post $none
	 */
	public abstract QTask migrateQulet();
	...
	public <T extends ResQTask> List<T> getQuletWaitingList() {
	 ...
	 */
	protected <T extends ResQTask> void setQuletWaitingList(List<T> quletWaitingList) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends ResQTask> List<T> getQuletExecList() {
	 ...
	 */
	protected <T extends ResQTask> void setQuletExecList(List<T> quletExecList) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends ResQTask> List<T> getQuletPausedList() {
	 ...
	 */
	protected <T extends ResQTask> void setQuletPausedList(List<T> quletPausedList) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends ResQTask> List<T> getQuletFinishedList() {
	 ...
	 */
	protected <T extends ResQTask> void setQuletFinishedList(List<T> quletFinishedList) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends ResQTask> List<T> getQuletFailedList() {
	 ...
	 */
	protected <T extends ResQTask> void setQuletFailedList(List<T> quletFailedList) {
