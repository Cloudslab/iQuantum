...
/**
 * QBrokerSimple implements a simple broker that submits QTasks to QNodes without checking the QubitMapping.
 * This broker is used for testing purpose only.
 * @see QBroker for a normal broker.
 */
public class QBrokerSimple extends QBroker {
    ...
    public QBrokerSimple(String name) throws Exception {
        super(name);
        numQTaskSubmitted = 0;
