...
package org.iquantum.backends.classical;
...
public class Host {
	...
	private CDatacenter CDatacenter;
	...
	public void addMigratingInVm(Vm vm) {
		...
		if (!getVmsMigratingIn().contains(vm)) {
			...
			getVmList().add(vm);
			updateVmsProcessing(iQuantum.clock());
			vm.getHost().updateVmsProcessing(iQuantum.clock());
		}
	}
	 ...
	 */
	public CDatacenter getDatacenter() {
		return CDatacenter;
	}
	 ...
	 * 
	 * @param CDatacenter the data center from this host
	 */
	public void setDatacenter(CDatacenter CDatacenter) {
		this.CDatacenter = CDatacenter;
	}
