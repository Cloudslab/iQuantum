package org.iquantum.backends.classical.container.utils;
...
/**
 * A factory for iQuantum entities' ids. iQuantum requires a lot of ids, that
...
public final class IDs {
    ...
    static {
        COUNTERS.put(ContainerCTask.class, 1);
