...
import org.iquantum.backends.classical.container.containerProvisioners.ContainerBwProvisioner;
import org.iquantum.backends.classical.container.containerProvisioners.ContainerPe;
import org.iquantum.backends.classical.container.containerProvisioners.ContainerRamProvisioner;
import org.iquantum.backends.classical.container.lists.ContainerPeList;
import org.iquantum.backends.classical.container.schedulers.ContainerScheduler;
...
//        Log.printLine("ContainerVm: addMigratingInContainer:......");
        ...
        if (!getContainersMigratingIn().contains(container)) {
            ...
            updateContainersProcessing(iQuantum.clock());
            container.getVm().updateContainersProcessing(iQuantum.clock());
        }
    }
