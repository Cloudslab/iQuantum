package org.iquantum.sdn.graph.example;
...
import org.iquantum.sdn.Activity;
...
import org.iquantum.sdn.example.SDNBroker;
import org.iquantum.sdn.example.SimpleNetworkOperatingSystem;
import org.iquantum.sdn.example.VmAllocationPolicyCombinedLeastFullFirst;
import org.iquantum.sdn.example.Workload;
import org.iquantum.sdn.example.VmSchedulerSpaceSharedEnergy;
...
public class GraphicSDNExample {
	...
	private void printCTaskList(List<CTask> list) {
		int size = list.size();
		String content = "";
		CTask cloudlet;
		...
		content = String.format(fString, "CTask_ID") + 
	...
	private void printCTask(CTask cloudlet) {
