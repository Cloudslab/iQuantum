 ...
 * Transmission and Channel is the same as CTask and CTaskScheduler,
...
public class Channel {
	...
	public boolean updatePackageProcessing(){
		...
		Log.printLine(iQuantum.clock() + ": Channel.updatePackageProcessing() ("+this.toString()+"):Time spent:"+timeSpent+
	...
	public double nextFinishTime() {
		...
		if (delay < NetworkOperatingSystem.getMinTimeBetweenNetworkEvents()) { 
			//Log.printLine(iQuantum.clock() + ":Channel: delay is too short: "+ delay);
