...
import org.iquantum.sdn.Switch;
import org.iquantum.sdn.example.policies.VmAllocationPolicyCombinedLeastFullFirst;
import org.iquantum.sdn.example.policies.VmAllocationPolicyCombinedMostFullFirst;
import org.iquantum.sdn.example.policies.VmAllocationPolicyMipsLeastFullFirst;
import org.iquantum.sdn.example.policies.VmAllocationPolicyMipsMostFullFirst;
import org.iquantum.sdn.overbooking.OverbookingNetworkOperatingSystem;
import org.iquantum.sdn.overbooking.VmAllocationPolicyOverbooking;
import org.iquantum.sdn.power.PowerUtilizationMaxHostInterface;

/**
 * iQuantumSDN example main program. It loads physical topology file, application
...
public class SDNExample {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting iQuantum SDN...");
		...
		try {
			...
			double finishTime = iQuantum.startSimulation();
			...
			if(SDNExample.logEnabled) 
				LogPrinter.printCTaskList(newList);
			...
			Log.printLine("iQuantum SDN finished!");
