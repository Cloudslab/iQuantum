...
import org.iquantum.sdn.Switch.HistoryEntry;
...
public class LogPrinter {
	...
	public static void printCTaskList(List<CTask> list) {
		int size = list.size();
		CTask cloudlet;
		...
		Log.print(String.format(fString, "CTask_ID"));
	...
	private static void printCTask(CTask cloudlet) {
