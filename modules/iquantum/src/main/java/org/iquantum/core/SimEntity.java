...
public abstract class SimEntity implements Cloneable {
	...
	public void schedule(int dest, double delay, int tag, Object data) {
		...
		iQuantum.send(id, dest, delay, tag, data);
	}
	...
	public void schedule(String dest, double delay, int tag, Object data) {
		schedule(iQuantum.getEntityId(dest), delay, tag, data);
	}
	...
	public void scheduleNow(String dest, int tag, Object data) {
		schedule(iQuantum.getEntityId(dest), 0, tag, data);
	}
	...
	public void scheduleFirst(int dest, double delay, int tag, Object data) {
		...
		iQuantum.sendFirst(id, dest, delay, tag, data);
	}
	...
	public void scheduleFirst(String dest, double delay, int tag, Object data) {
		scheduleFirst(iQuantum.getEntityId(dest), delay, tag, data);
	}
	...
	public void scheduleFirstNow(String dest, int tag, Object data) {
		scheduleFirst(iQuantum.getEntityId(dest), 0, tag, data);
	}
	...
	public int numEventsWaiting() {
		return iQuantum.waiting(id, iQuantum.SIM_ANY);
	}
	...
	public SimEvent getNextEvent() {
		return getNextEvent(iQuantum.SIM_ANY);
	}

	/**
	 * This method is invoked by the {@link iQuantum} class when the simulation is started.
	 ...
	 * This method is invoked by the {@link iQuantum} class whenever there is an event in the
	 ...
	 * This method is invoked by the {@link iQuantum} before the simulation finishes. If you want
	 ...
	 * @param iQuantumTag an user-defined number representing the type of an event/message
	 ...
	 * @post $none
	 */
	protected void send(int entityId, double delay, int iQuantumTag, Object data) {
		if (entityId < 0) {
			return;
		}
		...
		schedule(entityId, delay, iQuantumTag, data);
	}
	 ...
	 * @post $none
	 */
	protected void send(int entityId, double delay, int iQuantumTag) {
		send(entityId, delay, iQuantumTag, null);
	}
	 ...
	 * @post $none
	 */
	protected void send(String entityName, double delay, int iQuantumTag, Object data) {
		send(iQuantum.getEntityId(entityName), delay, iQuantumTag, data);
	}
	 ...
	 * @post $none
	 */
	protected void send(String entityName, double delay, int iQuantumTag) {
		send(entityName, delay, iQuantumTag, null);
	}
	 ...
	 * @post $none
	 */
	protected void sendNow(int entityId, int iQuantumTag, Object data) {
		send(entityId, 0, iQuantumTag, data);
	}
	 ...
	 * @post $none
	 */
	protected void sendNow(int entityId, int iQuantumTag) {
		send(entityId, 0, iQuantumTag, null);
	}
	 ...
	 * @post $none
	 */
	protected void sendNow(String entityName, int iQuantumTag, Object data) {
		send(iQuantum.getEntityId(entityName), 0, iQuantumTag, data);
	}
	 ...
	 * @post $none
	 */
	protected void sendNow(String entityName, int iQuantumTag) {
		send(entityName, 0, iQuantumTag, null);
	}
