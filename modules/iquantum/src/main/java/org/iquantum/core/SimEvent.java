...
public class SimEvent implements Cloneable, Comparable<SimEvent> {
	...
	private final Object data;
        ...
        /**
         * An attribute to help iQuantum to identify the order of received events
	...
	public String toString() {
		return "Time ="+this.time+", Event tag = " + tag + " source = " + iQuantum.getEntity(entSrc).getName() + " destination = "
				+ iQuantum.getEntity(entDst).getName();
	}
