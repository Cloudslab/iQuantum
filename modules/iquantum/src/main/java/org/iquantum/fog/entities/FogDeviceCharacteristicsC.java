...
import org.iquantum.lists.HostList;
import org.iquantum.lists.PeList;
import org.iquantum.fog.utils.GeoCoverage;

public class FogDeviceCharacteristicsC extends CDatacenterCharacteristics {
	...
	public FogDeviceCharacteristicsC(
			String architecture,
			String os,
			String vmm,
			final Host host,
	...
	public int getMips() {
		...
		// Assuming all PEs in all Machine have same rating.
			case FogDeviceCharacteristicsC.TIME_SHARED:
			case FogDeviceCharacteristicsC.OTHER_POLICY_SAME_RATING:
			...
			case FogDeviceCharacteristicsC.SPACE_SHARED:
			case FogDeviceCharacteristicsC.OTHER_POLICY_DIFFERENT_RATING:
