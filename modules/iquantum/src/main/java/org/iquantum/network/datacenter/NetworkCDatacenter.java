...
/**
 * NetworkDatacenter class is a {@link CDatacenter} whose hostList are virtualized and networked. It contains
 ...
 */
public class NetworkCDatacenter extends CDatacenter {
        /**
	 ...
	 * 
	 * @param name the name to be associated with this entity (as required by {@link org.iquantum.core.SimEntity})
	...
	protected void processCloudletSubmit(SimEvent ev, boolean ack) {
		...
		try {
			...
			if (estimatedFinishTime > 0.0) { // if this cloudlet is in the exec
				...
				send(getId(), 0.0001, iQuantumTags.VM_DATACENTER_EVENT);
			}
