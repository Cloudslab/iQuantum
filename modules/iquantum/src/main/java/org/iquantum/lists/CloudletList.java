...
public class CloudletList {
	...
	/**
	 * Gets a {@link CTask} with a given id.
	 * 
	 ...
	 */
	public static <T extends CTask> T getById(List<T> cloudletList, int id) {
	 ...
	 */
	public static <T extends CTask> int getPositionById(List<T> cloudletList, int id) {
		int i = 0 ;
	        for (T cloudlet : cloudletList) {
			if (cloudlet.getCloudletId() == id) {
				return i;
	 ...
	 * @post $none
	 */
	public static <T extends CTask> void sort(List<T> cloudletList) {
