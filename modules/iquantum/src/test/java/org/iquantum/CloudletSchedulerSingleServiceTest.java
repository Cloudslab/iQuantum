...
public class CloudletSchedulerSingleServiceTest {
	...
	@Test
	public void testCTaskSubmitLowUtilization() {
		UtilizationModel utilizationModel = createMock(UtilizationModel.class);
		expect(utilizationModel.getUtilization(0))
			.andReturn(0.11)
			.anyTimes();
		replay(utilizationModel);
		testCTaskSubmit(utilizationModel);
		verify(utilizationModel);
	}

	@Test
	public void testCTaskSubmitHighUtilization() {
		UtilizationModel utilizationModel = createMock(UtilizationModel.class);
		expect(utilizationModel.getUtilization(0))
			.andReturn(0.91)
			.anyTimes();
	...
	public void testCTaskSubmit(UtilizationModel utilizationModel) {
		CTask cloudlet = new CTask(0, CLOUDLET_LENGTH, PES_NUMBER, CLOUDLET_FILE_SIZE, CLOUDLET_OUTPUT_SIZE,
				utilizationModel, utilizationModel, utilizationModel);
		cloudlet.setResourceParameter(0, 0, 0);
