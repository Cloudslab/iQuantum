...
sx q[8];
cx q[8],q[5];
rz(-0.4742443121090174) q[5];
sx q[5];
rz(7*pi/8) q[5];
rz(-2.274649259782052) q[8];
sx q[8];
cx q[11],q[8];
sx q[11];
rz(-pi/2) q[8];
...
cx q[5],q[8];
cx q[8],q[5];
barrier q[11],q[8],q[1],q[16],q[14],q[12],q[22],q[7],q[21],q[18],q[24],q[23],q[15],q[25],q[10],q[13],q[19],q[4],q[5],q[3];
measure q[11] -> meas[0];
measure q[8] -> meas[1];
measure q[1] -> meas[2];
measure q[16] -> meas[3];
