...
sx q[23];
rz(pi/2) q[23];
barrier q[8],q[5],q[21],q[25],q[10],q[12],q[4],q[7],q[17],q[15],q[18],q[19],q[26],q[16],q[14],q[0],q[11],q[13],q[3],q[1],q[2],q[24],q[22],q[23];
measure q[8] -> meas[0];
measure q[5] -> meas[1];
measure q[21] -> meas[2];
measure q[25] -> meas[3];
