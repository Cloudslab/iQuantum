...
sx q[22];
rz(pi/2) q[22];
barrier q[23],q[21],q[18],q[17],q[24],q[8],q[9],q[16],q[11],q[2],q[0],q[26],q[19],q[20],q[13],q[22],q[15],q[25],q[12],q[3],q[6],q[1],q[4],q[10],q[5],q[7],q[14];
measure q[23] -> meas[0];
measure q[21] -> meas[1];
measure q[18] -> meas[2];
measure q[17] -> meas[3];
