...
creg c[20];
x q[1];
rz(0.10236775111344266) q[1];
rz(pi/2) q[2];
sx q[2];
rz(pi/2) q[2];
cx q[1],q[2];
rz(-0.10236775111344266) q[2];
cx q[1],q[2];
rz(0.10236775111344266) q[2];
sx q[3];
rz(-pi) q[3];
...
sx q[12];
cx q[12],q[10];
rz(0.7518543178873554) q[10];
sx q[12];
cx q[12],q[10];
x q[10];
rz(-2.322650644682252) q[10];
x q[12];
rz(0.1340799664366679) q[12];
rz(pi/2) q[13];
sx q[13];
rz(pi/2) q[13];
rz(pi/2) q[14];
...
cx q[18],q[15];
cx q[12],q[15];
rz(-0.1341753820403722) q[15];
cx q[12],q[15];
cx q[12],q[13];
cx q[13],q[12];
cx q[12],q[13];
rz(0.8050522922422332) q[13];
cx q[13],q[14];
rz(-0.2683507640807444) q[14];
cx q[13],q[14];
cx q[13],q[12];
rz(-0.5367015281614888) q[12];
cx q[13],q[12];
rz(0.5367015281614888) q[12];
rz(0.2683507640807444) q[14];
cx q[13],q[14];
cx q[14],q[13];
cx q[13],q[14];
rz(-0.34016023971364096) q[14];
cx q[14],q[16];
rz(0.1341753820403722) q[15];
rz(-1.0734030563229775) q[16];
cx q[14],q[16];
cx q[14],q[11];
rz(0.9947865409438383) q[11];
cx q[14],q[11];
rz(-0.9947865409438383) q[11];
sx q[14];
rz(1.0734030563229775) q[16];
...
sx q[16];
cx q[16],q[14];
rz(0.4187767550927806) q[14];
sx q[16];
cx q[16],q[14];
rz(-1.9895730818876771) q[14];
cx q[11],q[14];
cx q[14],q[11];
cx q[11],q[14];
...
sx q[22];
cx q[22],q[19];
rz(0.7332428166093365) q[19];
sx q[22];
cx q[22],q[19];
rz(2.304039143404233) q[19];
cx q[16],q[19];
cx q[19],q[16];
cx q[16],q[19];
cx q[20],q[19];
...
rz(pi/2) q[25];
cx q[22],q[25];
rz(-1.4664856332186729) q[25];
cx q[22],q[25];
cx q[22],q[19];
rz(0.2086213871524472) q[19];
cx q[22],q[19];
rz(-0.2086213871524472) q[19];
cx q[19],q[16];
cx q[16],q[19];
