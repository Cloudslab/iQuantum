...
rz(-pi) q[23];
sx q[23];
rz(1.531363192759013) q[23];
sx q[23];
rz(-pi) q[24];
sx q[24];
rz(-2.453940928053786) q[24];
cx q[24],q[23];
rz(-0.8129107602024314) q[23];
sx q[24];
cx q[24],q[23];
rz(0.699918704359443) q[23];
sx q[24];
cx q[24],q[23];
sx q[23];
rz(-1.1151361427856763) q[23];
sx q[23];
rz(0.5357807360417111) q[24];
sx q[24];
rz(-pi) q[24];
barrier q[24],q[23];
measure q[24] -> meas[0];
